...
| File | Size |
|---|---|
| `docs/mobile.png` | 2.1 MB |
| `docs/wireframes/VERA_layouts.svg` | 1.5 MB |
| `docs/architecture/VERA_architecture.svg` | 0.9 MB |
