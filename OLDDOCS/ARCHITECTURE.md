...
![Architecture](../docs/assets/architecture/VERA_architecture.svg)

*Editable source: [`architecture/VERA_architecture.drawio`](../docs/assets/architecture/VERA_architecture.drawio)*
